...
// Configuración de Supabase (las mismas que el frontend)
...
module.exports = async (req, res) => {
    if (req.method === 'POST') {
        ...
        try {
            ...
            await sendTelegramMessage(chatId, "Lo siento, ocurrió un error al procesar tu solicitud.");
        }
